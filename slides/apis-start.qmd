...
-   [publicapis.dev](https://publicapis.dev/)
    -   [publicapis.dev GitHub](https://github.com/marcelscruz/public-apis)
...
-   We aren't going to dig into the format yet because we won't use it directly
:::
