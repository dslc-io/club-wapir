...
-   If you want to use this API, sign up for your own key at https://api.open.fec.gov/developers/
-   OpenAPI 3.0 description at https://api.apis.guru/v2/specs/fec.gov/1.0/openapi.json
:::
...
-   "explode" to separate them as separate copies of that parameter,
