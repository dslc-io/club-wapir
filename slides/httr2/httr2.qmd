---
engine: knitr
title: How can I more easily access APIs from R?
resources:
...
saveRDS(
  openfec_response, 
  here::here("slides", "httr2", "httr2", "openfec_response.rds")
)
jsonlite::write_json(
  openfec_response, 
  here::here("slides", "httr2", "httr2", "openfec_response.json"),
  auto_unbox = TRUE,
  null = "null"
)
```
...
#| eval: true
#| include: false
openfec_response <- readRDS(here::here("slides", "httr2", "httr2", "openfec_response.rds"))
```
::: fragment
```{r}
